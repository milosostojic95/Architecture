...
if ( ! function_exists( 'architecture_posted_on' ) ) :
	...
	function architecture_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'architecture' ),
...
if ( ! function_exists( 'architecture_posted_by' ) ) :
	...
	function architecture_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'architecture' ),
	...
	function architecture_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( 'Posted in %1$s', 'architecture' ) . '</span>', $categories_list ); // WPCS: XSS OK.
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'architecture' ) . '</span>', $tags_list ); // WPCS: XSS OK.
			}
		}
